...
public enum MaterialName {
    ...
    public static MaterialName valueOf(ItemStack item) {
        try {
            return MaterialName.valueOf(item.getType().name() + "__" + item.getDurability());
        } catch (Exception | Error e) {
            return MaterialName.valueOf(item.getType().name() + "__0");
        }
    }

    public static MaterialName valueOf(String name, short durability) {
        try {
            return MaterialName.valueOf(name + "__" + durability);
        } catch (Exception | Error e) {
            return MaterialName.valueOf(name + "__0");
        }
    }

    public static MaterialName valueOf(String name, byte data) {
        try {
            return MaterialName.valueOf(name + "__" + data);
        } catch (Exception | Error e) {
            return MaterialName.valueOf(name + "__0");
        }
    }
    ...
    public static MaterialName valueOf(Material material, byte data) {
        try {
            return MaterialName.valueOf(material.name() + "__" + data);
        } catch (Exception | Error e) {
            return MaterialName.valueOf(material.name() + "__0");
        }
    }
    ...
    public static MaterialName valueOf(Item item) {
        return MaterialName.valueOf(item.getItemStack());
    }

    public static MaterialName valueOf(Block block) {
        return MaterialName.valueOf(block.getType(), block.getData());
    }
